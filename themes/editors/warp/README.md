...
`themes/editors/warp/themes/*.yaml` is canonical. `public/warp/*` is a served copy —
keep them in sync when editing. `themes/editors/warp/aurora_bg.py` regenerates the
background image.
...
python3 themes/editors/warp/aurora_bg.py
cp themes/editors/warp/themes/aurora.jpg public/warp/aurora.jpg
```
