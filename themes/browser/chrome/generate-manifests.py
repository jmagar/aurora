...
Writes loadable unpacked theme folders:
    themes/browser/chrome/aurora/        manifest.json + images/ntp.png   (dark)
    themes/browser/chrome/aurora-light/  manifest.json                    (light)
...
ROOT = os.path.abspath(os.path.join(HERE, "..", "..", ".."))  # themes/browser/chrome → repo root
