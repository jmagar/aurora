...
cp shell/bat/Aurora.tmTheme "$(bat --config-dir)/themes/"
bat cache --build
# ~/.config/bat/config:
#   --theme="Aurora"
...
terminal uses the Aurora palette (see [`editors/warp`](../../editors/warp)). This
...
`shell/bat/Aurora.tmTheme` is canonical.
