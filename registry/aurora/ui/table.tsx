...
function Table({ ref, className, ...props }: React.ComponentPropsWithRef<"table">) {
  return (
    <div
...
function TableHeader({ ref, ...props }: React.ComponentPropsWithRef<"thead">) {
  return <thead ref={ref} {...props} />
}

function TableBody({ ref, className, ...props }: React.ComponentPropsWithRef<"tbody">) {
  return (
...
function TableRow({ ref, className, style, ...props }: React.ComponentPropsWithRef<"tr">) {
  return (
    <tr
      ref={ref}
...
function TableHead({ ref, className, style, ...props }: React.ComponentPropsWithRef<"th">) {
  return (
...
function TableCell({ ref, className, style, ...props }: React.ComponentPropsWithRef<"td">) {
  return (
    <td
      ref={ref}
