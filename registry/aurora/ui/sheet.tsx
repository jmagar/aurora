...
export interface SheetContentProps extends React.ComponentPropsWithRef<typeof DialogPrimitive.Content> {
  side?: SheetSide
  hideClose?: boolean
}
...
function SheetContent({ ref, className, children, side = "right", style, hideClose = false, ...props }: SheetContentProps) {
  return (
    <SheetPortal>
...
function SheetTitle({ ref, style, ...props }: React.ComponentPropsWithRef<typeof DialogPrimitive.Title>) {
  return (
...
function SheetDescription({ ref, style, ...props }: React.ComponentPropsWithRef<typeof DialogPrimitive.Description>) {
  return (
