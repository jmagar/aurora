...
export function FilterSearch({ ref, className, onClear, value, onChange, ...rest }: FilterSearchProps & { ref?: React.Ref<HTMLInputElement> }) {
  return (
...
export function FilterTag({ ref, children, onRemove, className, ...rest }: FilterTagProps & { ref?: React.Ref<HTMLSpanElement> }) {
  return (
    <span
      ref={ref}
      className={cn(
...
export function FilterTagRose({ ref, children, onRemove, className, ...rest }: FilterTagProps & { ref?: React.Ref<HTMLSpanElement> }) {
  return (
    <span
      ref={ref}
      className={cn(
...
export function FilterBar(
  { ref, children, onClearAll, showClearAll = false, className, ...rest }: FilterBarProps & { ref?: React.Ref<HTMLDivElement> },
) {
  return (
    <div
      ref={ref}
