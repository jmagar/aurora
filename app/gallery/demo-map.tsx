...
/**
 * Gallery demo registry — slug → lazily-loaded demo component. Shared by the
 * gallery section pages and the live component catalog (components/site/
 * component-catalog.tsx), so every catalog tile renders the same demo the
 * gallery page does and the two can never drift.
 */
...
export { DEMOS, NON_REGISTRY_DEMOS }
